...
@MicronautTest
class MihaiControllerTest(private val embeddedServer: EmbeddedServer) {
    ...
    fun testIndex() {
        ...
        assertEquals(HttpStatus.OK, client.toBlocking().exchange("/mihai", String::class.java).status())
        client.close()
    }
}
